...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    console.log("Attempting to send delivered email via Resend to:", order.customer_email);
    ...
    console.log("Order delivered email sent successfully via Resend:", emailResponse);
